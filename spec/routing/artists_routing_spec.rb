...
RSpec.describe ArtistsController, type: :routing do
  ...
  describe "/artist/album/music routing" do
    ...
    it "routes to #create" do
      expect(post: "/artists/1/albums/1/musics").to route_to("artists/albums/musics#create", artist_id: "1", album_id: "1")
    end

    it "routes to #update via PUT" do
      expect(put: "/artists/1/albums/1/musics/1").to route_to("artists/albums/musics#update", artist_id: "1", album_id: "1", id: "1")
    end

    it "routes to #update via PATCH" do
      expect(patch: "/artists/1/albums/1/musics/1").to route_to("artists/albums/musics#update", artist_id: "1", album_id: "1", id: "1")
    end

    it "routes to #destroy" do
      expect(delete: "/artists/1/albums/1/musics/1").to route_to("artists/albums/musics#destroy", artist_id: "1", album_id: "1", id: "1")
    end
  end
  ...
  describe "/artist/music routing" do
    ...
    it "routes to #create" do
      expect(post: "/artists/1/musics").to route_to("artists/musics#create", artist_id: "1")
    end

    it "routes to #update via PUT" do
      expect(put: "/artists/1/musics/1").to route_to("artists/musics#update", artist_id: "1", id: "1")
    end

    it "routes to #update via PATCH" do
      expect(patch: "/artists/1/musics/1").to route_to("artists/musics#update", artist_id: "1", id: "1")
    end

    it "routes to #destroy" do
      expect(delete: "/artists/1/musics/1").to route_to("artists/musics#destroy", artist_id: "1", id: "1")
    end
  end
end
