...
RSpec.describe '/artist_bookmarks', type: :request do
  ...
  context 'POST /users/artists/artist_bookmarks' do
  ...
  context 'DELETE /users/artists/artist_bookmarks' do
      it 'with Authorization header' do
        delete artist_artist_bookmark_path(artist_id: artist_bookmark.artist_id, id: artist_bookmark.id), headers: headers
