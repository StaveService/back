...
ActiveRecord::Schema.define(version: 20_210_803_060_901) do
  ...
  create_table 'album_bookmarks', force: :cascade do |t|
    ...
    t.index %w[album_id user_id], name: 'index_album_bookmarks_on_album_id_and_user_id', unique: true
  ...
  create_table 'album_musics', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[album_id music_id], name: 'index_album_musics_on_album_id_and_music_id', unique: true
  ...
  create_table 'artist_albums', force: :cascade do |t|
    ...
    t.index %w[artist_id album_id], name: 'index_artist_albums_on_artist_id_and_album_id', unique: true
  ...
  create_table 'artist_bands', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[artist_id band_id], name: 'index_artist_bands_on_artist_id_and_band_id', unique: true
  ...
  create_table 'artist_bookmarks', force: :cascade do |t|
    ...
    t.index %w[user_id artist_id], name: 'index_artist_bookmarks_on_user_id_and_artist_id', unique: true
  ...
  create_table 'artist_musics', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[artist_id music_id], name: 'index_artist_musics_on_artist_id_and_music_id', unique: true
  ...
  create_table 'band_albums', force: :cascade do |t|
    ...
    t.index %w[band_id album_id], name: 'index_band_albums_on_band_id_and_album_id', unique: true
  ...
  create_table 'band_bookmarks', force: :cascade do |t|
    ...
    t.index %w[user_id band_id], name: 'index_band_bookmarks_on_user_id_and_band_id', unique: true
  ...
  create_table 'composer_musics', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[artist_id music_id], name: 'index_composer_musics_on_artist_id_and_music_id', unique: true
  ...
  create_table 'lyrist_musics', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[artist_id music_id], name: 'index_lyrist_musics_on_artist_id_and_music_id', unique: true
  ...
  create_table 'music_bookmarks', force: :cascade do |t|
    ...
    t.index %w[user_id music_id], name: 'index_music_bookmarks_on_user_id_and_music_id', unique: true
  ...
  create_table 'user_relationships', force: :cascade do |t|
    ...
    t.index %w[follower_id followed_id], name: 'index_user_relationships_on_follower_id_and_followed_id',
                                         unique: true
